...
if __name__ == '__main__':
    ...
    caffemodel = 'count/count_30.9.caffemodel'
    ...
    fs=open('results_30.9.txt','a')
    matfn='/home/yarley/yanxp/WSD/count_wsl/fast-rcnn-count/data/selective_search_data/voc_2007_test.mat'
